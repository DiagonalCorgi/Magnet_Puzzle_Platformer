Shader "Custom/EditedStandardParticleShaer"
{
	Properties
	{
		...
		SubShader
		{
			Tags { "RenderType" = "Opaque" "IgnoreProjector" = "True" "PreviewType" = "Plane" "PerformanceChecks" = "False"  "Queue" = "Overlay" }
			...
			Pass
			{
				...
				Tags { "LightMode" = "SceneSelectionPass" "Queue" = "Overlay" }
			...
			Pass
			{
				...
				Tags{ "LightMode" = "Picking" "Queue" = "Overlay" }
